...
public class SegTelefonoxcompany implements Serializable {
    ...
    @NotNull
    @GeneratedValue (strategy = GenerationType.SEQUENCE, generator = "TELEFONOXCOMPANY_SEQ")
    @SequenceGenerator(name = "TELEFONOXCOMPANY_SEQ", sequenceName = "sqe_idtelxconsul ", allocationSize = 1)
