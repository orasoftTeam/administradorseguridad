...
public class SegCompanyxdiasfestivos implements Serializable {
    ...
    @NotNull
    @GeneratedValue (strategy = GenerationType.SEQUENCE, generator = "COMDIAFEST_SEQ")
    @SequenceGenerator(name = "COMDIAFEST_SEQ", sequenceName = "SQE_IDCONSXFESTIVOS", allocationSize = 1)
